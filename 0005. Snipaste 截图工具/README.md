...
- [5. 💻 文本截图](#5--文本截图)
- [6. 💻 快速截全屏](#6--快速截全屏)
- [7. ⏰ 使用贴图，快速拼出简易的封面](#7--使用贴图快速拼出简易的封面)
- [8. 🤔 问：snipaste 将来来会支持长截图（滚动截图）功能吗？](#8--问snipaste-将来来会支持长截图滚动截图功能吗)
- [9. 🤔 问：snipaste 的设计初衷是？](#9--问snipaste-的设计初衷是)
- [10. 🤔 问：对于 snipaste 来说，何为一次完整的截图？](#10--问对于-snipaste-来说何为一次完整的截图)
- [11. 🤔 问：如何开启自动检测窗口？](#11--问如何开启自动检测窗口)
- [12. 🤔 问：如何实现无损截图？](#12--问如何实现无损截图)
- [13. 🤔 问：能被复制的内容就能被贴出来吗？](#13--问能被复制的内容就能被贴出来吗)
<!-- endregion:toc -->
- 内容概述：
  - Snipaste 是什么？
  - 取色
...
- ![](assets/2024-12-13-13-37-34.png)
...
- https://www.bilibili.com/video/BV1Ak4y1h7st
  ...
  - 【省流】一句话阐述视频内容
    ...
    - ![](assets/2024-12-13-13-45-39.png)
...
## 3. 🔍 查看我的 snipaste 首选项配置

- 下面记录了个人在 `23.03.03` 时的 snipaste 首选项配置。之后的配置可能会有所变化，不过在这个时间点之前录制的视频，使用的是这些配置。
  - ![](assets/2024-12-13-13-58-42.png)
  - ![](assets/2024-12-13-13-56-14.png)
  - ![](assets/2024-12-13-13-56-59.png)
  - ![](assets/2024-12-13-13-57-17.png)
  - ![](assets/2024-12-13-13-57-29.png)
  - ![](assets/2024-12-13-13-57-37.png)
  - ![](assets/2024-12-13-13-57-43.png)
  - ![](assets/2024-12-13-13-57-49.png)
  - ![](assets/2024-12-13-13-57-55.png)
  - ![](assets/2024-12-13-13-58-02.png)
  - ![](assets/2024-12-13-13-58-08.png)
  - ![](assets/2024-12-13-13-58-14.png)
  - ![](assets/2024-12-13-13-58-36.png)
...
- **【流程说明】**
  ...
  - **打开开发者工具**
    - 方式1：右键页面任意位置，选择检查
      - ![](assets/2024-12-13-14-05-12.png)
...
- **Q：如果不想截取整个页面，指向截取某个区域，该如何做呢？**
  ...
  - ![](assets/2024-12-13-14-09-33.png)
...
## 8. 🤔 问：snipaste 将来来会支持长截图（滚动截图）功能吗？
...
- 在【[少数派](https://sspai.com/)】上看到了一篇有关 snipaste 的文章，介绍了有关 snipaste 的相关内容，里面提到了作者对于 snipaste 的设计初衷的回复。感觉作者的这个回复很 nice，因为自己在使用 snipaste 时，更多时候也不是将其视作一个截图工具来使用，而是当做一个临时笔记来用。把一些想要看的内容给临时贴到屏幕上来看，如果是纯文本的话，每个贴图还能作为文本的容器，需要这些文本时随取随用即可。
  - [幕后丨他做了最强免费「截图」工具 Snipaste 后，还有上万字的话想说 - 少数派](https://sspai.com/post/35097)，这是某次在少数派上看到的文章 —— 一篇关于作者的采访，简言之就是这东西做出来是为了方便自身学习的，想写就写，自身没需求就不写……
    ...
    - ![](assets/2024-12-13-14-18-14.png)

## 10. 🤔 问：对于 snipaste 来说，何为一次完整的截图？
...
![](assets/2024-12-13-14-20-31.png)
